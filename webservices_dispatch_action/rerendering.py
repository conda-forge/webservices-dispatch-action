...
This message was generated by rerendering workflow run [{}]({}).
""".format(pr_branch, pr_owner, pr_repo, run_link, run_link)
        finally:
            git_repo.remotes.origin.set_url(
...
logs of this [rerendering workflow run]({run_link}) for errors. You can \
also ping conda-forge/core for further assistance or try \
[re-rendering locally]({doc_url}).

This message was generated by rerendering workflow run [{run_link}]({run_link}).
"""
        else:
            message = f"""\
Hi! This is the friendly automated conda-forge-webservice.
